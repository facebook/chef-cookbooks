...
cookbook_file '/etc/consul/consul-agent-ca.pem' do
...
cookbook_file '/etc/consul/consul-agent-ca-key.pem' do
  only_if do
...
cookbook_file '/etc/consul/consul-server.pem' do
  only_if do
    node['fb_consul']['config']['server'] &&
    node['fb_consul']['certificate_cookbook']
  end
...
cookbook_file '/etc/consul/consul-server-key.pem' do
  only_if do
    node['fb_consul']['config']['server'] &&
    node['fb_consul']['certificate_cookbook']
  end
