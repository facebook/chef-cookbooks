if Chef::VERSION < '16'
  ...
  Chef::Log.warn('[chef_json_recipes_backport] unsupported below Chef client version 16')
  return
elsif Chef::VERSION >= '19.1.53' || Chef::VERSION >= '18.7.28'
  Chef::Log.info('[chef_json_recipes_backport] Not loading JSON recipe monkeypatch,')
  Chef::Log.info("[chef_json_recipes_backport] since it's already in this version of Chef")
  return
end
Chef::Log.info('[chef_json_recipes_backport] Loading JSON recipe monkeypatch')
