...
* `node.centos5?`
    Is CentOS Linux 5 - Deprecated: use `node.centos_v?`

* `node.centos6?`
    Is CentOS Linux 6 - Deprecated: use `node.centos_v?`

* `node.centos7?`
    Is CentOS Linux 7 - Deprecated: use `node.centos_v?`

* `node.centos8?`
    Is CentOS Linux 8 or CentOS Stream 8 - Deprecated: use `node.centos_v?`

* `node.centos9?`
    Is CentOS Stream 9 - Deprecated: use `node.centos_v?`

* `node.centos10?`
    Is CentOS Stream 10 - Deprecated: use `node.centos_v?`
...
* `node.fedora_v?(v)`
   Is this Fedora version v (e.g. `node.fedora_v?(41)`)

* `node.fedora27?`
    Is Fedora 27 - Deprecated, use `node.fedora_v?`

* `node.fedora28?`
    Is Fedora 28 - Deprecated use `node.fedora_v?`

* `node.fedora29?`
    Is Fedora 29 - Deprecated use `node.fedora_v?`

* `node.fedora30?`
    Is Fedora 30 - Deprecated use `node.fedora_v?`

* `node.fedora31?`
    Is Fedora 31 - Deprecated use `node.fedora_v?`

* `node.fedora32?`
    Is Fedora 32 - Deprecated use `node.fedora_v?`

* `node.fedora33?`
    Is Fedora 33 - Deprecated use `node.fedora_v?`

* `node.fedora34?`
    Is Fedora 34 - Deprecated use `node.fedora_v?`

* `node.fedora35?`
    Is Fedora 35 - Deprecated use `node.fedora_v?`

* `node.fedora36?`
    Is Fedora 36 - Deprecated use `node.fedora_v?`

* `node.fedora37?`
    Is Fedora 37 - Deprecated use `node.fedora_v?`

* `node.fedora38?`
    Is Fedora 38 - Deprecated use `node.fedora_v?`

* `node.fedora39?`
    Is Fedora 39 - Deprecated use `node.fedora_v?`

* `node.fedora40?`
    Is Fedora 40 - Deprecated use `node.fedora_v?`
...
* `node.redhat6?`
    Is Redhat Enterprise Linux 6 - Deprecated use `node.redhat_v?`

* `node.redhat7?`
    Is Redhat Enterprise Linux 7 - Deprecated use `node.redhat_v?`

* `node.redhat8?`
    Is Redhat Enterprise Linux 8 - Deprecated use `node.redhat_v?`

* `node.redhat9?`
    Is Redhat Enterprise Linux 9 - Deprecated use `node.redhat_v?`

* `node.redhat10?`
    Is Redhat Enterprise Linux 10 - Deprecated use `node.redhat_v?`
...
* `node.rhel7?`
    Is Redhat Enterprise Linux 7 - Deprecated use `node.rhel_v?`

* `node.rhel8?`
    Is Redhat Enterprise Linux 8 - Deprecated use `node.rhel_v?`

* `node.rhel8_8?`
    Is Redhat Enterprise Linux 8.8 - Deprecated use `node.rhel_v?`

* `node.rhel9?`
    Is Redhat Enterprise Linux 9 - Deprecated use `node.rhel_v?`

* `node.rhel10?`
    Is Redhat Enterprise Linux 10 - Deprecated use `node.rhel_v?`
...
* `node.oracle5?`
    Is Oracle Enterprise Linux 5 - Deprecated use `node.oracle_v?`

* `node.oracle6?`
    Is Oracle Enterprise Linux 6 - Deprecated use `node.oracle_v?`

* `node.oracle7?`
    Is Oracle Enterprise Linux 7 - Deprecated use `node.oracle_v?`

* `node.oracle8?`
    Is Oracle Enterprise Linux 8 - Deprecated use `node.oracle_v?`
...
* `node.ubuntu12?`
    Is Ubuntu12 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu14?`
    Is Ubuntu14 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu15?`
    Is Ubuntu15 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu16?`
    Is Ubuntu16 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu1610?`
    Is Ubuntu16.10 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu17?`
    Is Ubuntu17 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu1704?`
    Is Ubuntu17.04 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu18?`
    Is Ubuntu18 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu1804?`
    Is Ubuntu18.04 - Deprecated, use `node.ubuntu_v?`

* `node.ubuntu20?`
    Is Ubuntu20 - Deprecated, use `node.ubuntu_v?`
...
* `node.macos10?`
    Is macOS Catalina (macOS 10) - Deprecated use `node.macos_v?`

* `node.macos11?`
    Is macOS Big Sur (macOS 11) - Deprecated use `node.macos_v?`

* `node.macos12?`
    Is macOS Monterey (macOS 12) - Deprecated use `node.macos_v?`
