...
describe Bookworm::Reports::RoleRecipeEntrypoints do
  ...
  describe 'with roles containing recipes' do
    let(:roles) do
      {
        'base_role' => {
        ...
        'web_role' => {
          'RoleRunListRecipes' => ['fb_apache::default', 'fb_init::default'],
        },
      }
    end

    it 'returns sorted unique recipe names' do
      expect(report.to_a).to eq([
        'fb_apache::default',
        'fb_helpers::default',
        'fb_init::default',
    ...
    it 'output returns sorted unique recipe names' do
      expect(report.output).to eq([
        'fb_apache::default',
        'fb_helpers::default',
        'fb_init::default',
